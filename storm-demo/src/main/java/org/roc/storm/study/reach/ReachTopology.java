 ...
 */
package org.roc.storm.study.reach;
...
public class ReachTopology {
        ...
        public void execute(Tuple tuple, BasicOutputCollector collector) {
            ...
            if (tweeters != null) {
                for (String tweeter : tweeters) {
                    LOG.warn("GetTweeters emit id={}, url={}, tweeter={}", id, url, tweeter);
        ...
        public void execute(Tuple tuple, BasicOutputCollector collector) {
            ...
            if (followers != null) {
                for (String follower : followers) {
                    LOG.warn("GetFollowers emit id={}, follower={}", id, follower);
    ...
    public static class PartialUniquer extends BaseBatchBolt {
        ...
        public void execute(Tuple tuple) {
            ...
            LOG.warn("PartialUniquer receive id={}, follower={}", id, follower);
    ...
    public static class CountAggregator extends BaseBatchBolt {
        ...
        public void execute(Tuple tuple) {
            Object id = tuple.getValue(0);
            Integer partialCount = tuple.getInteger(1);
            LOG.warn("CountAggregator receive id={}, partialCount={}", id, partialCount);
            _count += partialCount;
        }
